        ...
        <div className="w-full">
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 bg-gradient-to-r from-slate-300 to-slate-400 rounded-tr-full rounded-bl-full">
                <div className="col-span-4 grid justify-items-center text-center">
                    ...
                    <p>
                    Esses dados estão no estudo &lsquo;Reforma administrativa: diagnósticos sobre a empregabilidade, o desempenho e a eficiência do setor público&lsquo;, feito pelo Instituto Millenium em parceria com a consultoria de data science Octahedron Data Experts (ODX), lançado recentemente e que também embasa a &lsquo;Campanha Destrava&lsquo; —movimento apartidário que conta com a adesão de parlamentares, especialistas em administração e finanças públicas, empresários e sociedade civil em geral, clamando pelo debate urgente de uma reforma administrativa.

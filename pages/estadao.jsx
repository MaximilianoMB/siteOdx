        ...
        <div className="w-full">
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 bg-gradient-to-r from-slate-300 to-slate-400 rounded-tr-full rounded-bl-full">
                <div className="col-span-4 grid justify-items-center text-center">
                    ...
                    <p className="py-2">
                    &lsquo;Dados que constam de estudo do Instituto Millenium, mostram que País está no top five global não só em produtos como soja e milho, mas também em pimenta, melancia, caju e mandioca, enter outros...&lsquo;
                    </p><br></br>
